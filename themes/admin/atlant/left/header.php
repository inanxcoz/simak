...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title>HOME <?php echo cfg('app_aplikasi');?></title>            
        ...
        <style type="text/css">
            .x-navigation > li.xn-logo > a:first-child {
                background:#fff url("<?php echo themeUrl();?>/img/logo-login.png") no-repeat scroll center top;
            ...
            .page-content-header,.page-container .page-content{
                background:#fff url('<?php echo themeUrl();?>/img/backgrounds/wall_11.jpg') center top;
