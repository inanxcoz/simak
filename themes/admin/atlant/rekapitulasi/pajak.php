                ...
                <tbody style="text-align: center;">
                    ...
                    ?>
                            <?php if ($pajak != $r->pajak_tahun) { ?>
                                <tr>
                                    <td colspan="11" style="text-align: left;"><b>Tahun Pajak : <?php echo $r->pajak_tahun; ?></b></td>
                                </tr>
                            <?php }
                            $pajak = $r->pajak_tahun; ?>
                            <tr valign="top">
                                ...
                                <td><?php if (isset($r->pajak_file) && trim($r->pajak_file) != "") { ?>
                                        <a href="<?php echo get_image(base_url() . 'assets/collections/pajak/' . $r->pajak_file); ?>" target="_blank" title="<?php echo $r->pajak_file; ?>" class="label label-default">
                                            File
                                        </a>
                                    <?php } ?>
                                </td>
