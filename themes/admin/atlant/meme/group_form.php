...
<form id="form-validated" enctype="multipart/form-data" action="<?php echo $own_links;?>/save" class="form-horizontal" method="post"> 
        ...
        <div class="row">
        	...
        	<div class="row form-group">  
              ...
              <div class="col-md-5">
                <input type="text" id="group_name" maxlength="50" name="group_name" class="validate[required] form-control" value="<?php echo isset($val->ag_group_name)?$val->ag_group_name:'';?>" autocomplete="off"/>
              </div>
            </div> 
            ...
            <div class="row form-group">
              ...
              <div class="col-md-5">
                <input type="text" id="group_desc" name="group_desc" maxlength="50" class="validate[required] form-control" value="<?php echo isset($val->ag_group_desc)?$val->ag_group_desc:'';?>" autocomplete="off"/>
              </div> 
            </div> 
