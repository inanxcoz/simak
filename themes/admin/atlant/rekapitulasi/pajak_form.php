...
<form id="form-validated" enctype="multipart/form-data" action="<?php echo $own_links; ?>/save" class="form-horizontal" method="post">
  ...
  <div class="row">
    ...
    <div class="col-md-6">      
      <div class="row form-group">
        <div class="col-md-4 control-label">File Dokumen BPN</div>
        <div class="col-md-7">
          <input type="file" id="pajak_file" class="fileinput btn-primary" name="pajak_file" />
          <?php if (isset($val->pajak_file) && trim($val->pajak_file) != "") { ?>
            <a href="<?php echo get_image(base_url() . 'assets/collections/pajak/' . $val->pajak_file); ?>" title="<?php echo $val->pajak_file; ?>" class="act_modal btn btn-info" rel="700|400">
              File
            </a>
          <?php } ?>
      ...
      <div class="row form-group">
        <div class="col-md-4 control-label">File Dokumen EBupot</div>
        <div class="col-md-7">
          <input type="file" id="pajak_file_bupot" class="fileinput btn-primary" name="pajak_file_bupot" />
          <?php if (isset($val->pajak_file_bupot) && trim($val->pajak_file_bupot) != "") { ?>
            <a href="<?php echo get_image(base_url() . 'assets/collections/pajak/' . $val->pajak_file_bupot); ?>" title="<?php echo $val->pajak_file_bupot; ?>" class="act_modal btn btn-info" rel="700|400">
              File
            </a>
          <?php } ?>
          <div class="help-block">Max File 5Mb, File Support (Jpg,Png,Pdf,Zip)</div>
