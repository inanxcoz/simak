 	...
 	<div class="well">
 		<div class="row">
 			<?php if ($this->jCfg['user']['is_all'] == 1 ||  $this->jCfg['user']['is_all'] == 0) { ?>
 				...
 				<?php } ?>
 				<div class="col-md-2">
 					<input type="text" class="form-control" id="keyword" name="keyword" autocomplete="off" value="<?php echo $this->jCfg['search']['keyword']; ?>" placeholder="Keyword" />
 				</div>
 			<?php } else { ?>
 			...
 			<?php if ($this->is_search_date == true) { ?>
 				<div class="col-md-2" style="margin-top:0px;">
 					<div class="input-group">
 						...
 						<input type="text" id="date_start" name="date_start" autocomplete="off" class="form-control datepicker" placeholder="Start Date" value="<?php echo $this->jCfg['search']['date_start']; ?>" />
 					</div>
 				</div>
 				<div class="col-md-2" style="margin-top:0px;">
 					<div class="input-group">
 						<span class="input-group-addon"><span class="fa fa-calendar"></span></span>
 						<input type="text" id="date_end" name="date_end" autocomplete="off" class="form-control datepicker" placeholder="End Date" value="<?php echo $this->jCfg['search']['date_end']; ?>" />
 					</div>
 				</div>
 			<?php } ?>
 			<div class="col-md-2" style="margin-top:0px;">
