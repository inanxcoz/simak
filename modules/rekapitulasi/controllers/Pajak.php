...
class Pajak extends AdminController
{
    function __construct()
    {
        ...
        $this->_set_title('Data Rekapitulasi Pajak Badan');
        $this->DATA->table = "app_pajak";
        $this->folder_view = "rekapitulasi/";
        $this->prefix_view = strtolower($this->_getClass());

        $this->upload_path = cfg('upload_path_pajak') . "/";

        $this->breadcrumb[] = array(
            "title"     => "Data Rekap Rekapitulasi Pajak",
            "url"       => $this->own_link
        );
    ...
    function index()
    {
        ...
        $this->data_table = $this->M->pajak($par_filter);
    ...
    function save(){
        ...
        array(
            'id'        => $id ,
            'input'     => 'pajak_file_bupot',
            'param'     => array(
                            'field' => 'pajak_file_bupot', 
                            'par'   => array('pajak_id' => $id)
                        )
        ));
