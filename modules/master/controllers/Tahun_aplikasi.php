...
class Tahun_aplikasi extends AdminController
{
    function __construct()
    {
        ...
        $this->_set_title('Data Master Tahun Aplikasi');
        $this->DATA->table = "app_tahun";
        $this->folder_view = "master/";
        $this->prefix_view = strtolower($this->_getClass());

        $this->upload_path = cfg('upload_path_tahun') . "/";

        $this->breadcrumb[] = array(
            "title"     => "Data Tahun Aplikasi",
            "url"       => $this->own_link
        );
    ...
    function index()
    {
        ...
        $this->data_table = $this->M->tahun_aplikasi($par_filter);
    ...
    function export_data(){
        ...
        $this->db->order_by('tahun_id', 'ASC');
        $data = $this->M->tahun_aplikasi($par_filter);
    ...
    function save(){
        ...
        $data = array(
            'tahun_angka'      => $this->input->post('tahun_angka'),
            'tahun_status'     => $this->input->post('tahun_status')
        );      
        
        $a = $this->_save_master( 
            $data,
            array(
                'tahun_id' => dbClean($_POST['tahun_id'])
            ),
            dbClean($_POST['tahun_id'])           
        );
